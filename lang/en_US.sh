...
messages=(
    ...
    ["unzipping"]="Unzipping"
    ["waiting_for_quantisnetd_to_respond"]="Waiting for quantisnetd to respond..."
    ["deleting_cache_files"]="Deleting cache files, debug.log... "
    ["starting_quantisnetd"]="Starting quantisnetd... "
    ...
    ["usage_restart_description"]="restarts quantisnetd and deletes:"
    ...
    ["status_quantisnetdip"]="  quantisnetd bind ip address      : "
    ["status_quantisnetdve"]="  quantisnetd version              : "
    ["status_uptodat"]="  quantisnetd up-to-date           : "
    ["status_running"]="  quantisnetd running              : "
    ["status_uptimed"]="  quantisnetd uptime               : "
    ["status_drespon"]="  quantisnetd responding (rpc)     : "
    ["status_dlisten"]="  quantisnetd listening  (ip)      : "
    ["status_dconnec"]="  quantisnetd connecting (peers)   : "
    ["status_dportop"]="  quantisnetd port open            : "
    ["status_dconcnt"]="  quantisnetd connection count     : "
    ["status_dblsync"]="  quantisnetd blocks synced        : "
    ["status_dbllast"]="  last block (local quantisnetd)   : "
    ["status_webchai"]="             (chainz)        : "
    ["status_webdark"]="             (dash.org)      : "
    ["status_webdash"]="             (dashwhale)     : "
    ["status_webmast"]="             (masternode.me) : "
    ["status_dcurdif"]="  quantisnetd current difficulty   : "
