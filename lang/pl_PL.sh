...
messages=(
    ...
    ["unzipping"]="Unzipping"
    ["waiting_for_quantisnetd_to_respond"]="Czekam na odpowiedź quantisnetd..."
    ["deleting_cache_files"]="Usuwanie plików cache, debug.log... "
    ["starting_quantisnetd"]="Uruchamianie quantisnetd... "
    ...
    ["usage_install_description"]="tworzy świeżą instalację i uruchamia quantisnetd"
    ["usage_update_description"]="aktualizuje quantisnetd do najnowszej wersji i uruchamia ponownie (patrz ponizej)"
    ["usage_restart_description"]="restartuje quantisnetd i usuwa:"
    ...
    ["status_quantisnetdip"]="  przypisany adres IP                : "
    ["status_quantisnetdve"]="  wersja quantisnetd                       : "
    ["status_uptodat"]="  quantisnetd zauktualizowany              : "
    ["status_running"]="  quantisnetd uruchomiony                  : "
    ["status_uptimed"]="  czas pracy quantisnetd                   : "
    ["status_drespon"]="  quantisnetd odpowiada (rpc)              : "
    ["status_dlisten"]="  quantisnetd nasłuchuje (ip)              : "
    ["status_dconnec"]="  quantisnetd połączony (peers)            : "
    ["status_dportop"]="  otwarty port quantisnetd                 : "
    ["status_dconcnt"]="  liczba połączeń quantisnetd              : "
    ["status_dblsync"]="  zsynchronizowany quantisnetd             : "
    ["status_dbllast"]="  ostatni blok (lokalny quantisnetd)       : "
